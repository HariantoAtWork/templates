    ...
    <div class="max-w-md w-fill space-y-8">
      ...
      <form class="mt-8 space-y-6" @submit.prevent="handleSignIn">
        <div class="form-group rounded-md shadow-sm -space-y-px flex flex-col">
          ...
          <div>
            ...
            <UInput id="password" v-model="form.password" name="password" type="password" autocomplete="current-password" required
              class="w-full"
        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center">
            <UCheckbox id="remember-me" v-model="form.rememberMe" name="remember-me" type="checkbox" label="Remember me" />
          </div>
      ...
      <div class="mt-6">
        ...
        <div class="mt-6 grid grid-cols-2 gap-3">
          <UButton :disabled="socialLoading"
